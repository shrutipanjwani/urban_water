...
export class cards extends Component {
    render() {
        const cardInfo = [
            ...
            {
                image: process.env.PUBLIC_URL + "/images/Drainage-strategy-urban-water.jpg",
            ...
            {
                image: process.env.PUBLIC_URL + "/images/Climate-change-adaptation-urban-water.jpg",
        ...
        const renderCard = (card, index) => {
            return(
                ...
                <section className="grid px-8 py-2" style={{margin: '60px 0'}}>
                ...
                <button
                   className="w-51 flexDirection-center justify-center py-2 text-white font-semibold transition duration-300 hover:bg-blue-400">
        ...
        return (
            ...
            <div>
                <h2 className='card_head w-full sm:w-11/12 px-8 sm:mr-auto sm:ml-auto md:px-0'> Our Services</h2>
                <p className='card_p w-full sm:w-11/12 px-8 sm:mr-auto sm:ml-auto md:px-0'>We can help your project from planning approval to construction</p>
                <div  className='grid'>
